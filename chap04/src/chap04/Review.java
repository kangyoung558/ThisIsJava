...
public class Review {
	public static void main(String[] args) {
		...
		// switch(변수) // 정수, 문자, 문자열 (같은 값여부를 비교)
		// case : switch 변수와 일치하는 값을 찾아 다음 문장을 반영
		// break : switch문을 벗어남
		
		
		// for(초기식;조건식;증감식) {문장}  
		// 초기식 수행후 > 조건식 검사 > 참일 경우 문장 수행 > 증감식 > 조건식을 재 검사 
		// .. 조건식이 거짓일 때 까지 반복
		
		// while(조건식) {문장}
		// 조건식 검사 > 참일 경우 문장 수행 > 조건식 재검사 .. 조건식이 거짓일 때 까지 반복
		
		// do {문장} while(조건식);
		// 문장 수행 > 조건식 검사 > 참일 경우 문장 재수행 > 조건식 검사 .. 조건식이 거짓일때 까지
